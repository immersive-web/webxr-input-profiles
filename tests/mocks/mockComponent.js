class MockComponent {
  constructor(componentIndex, mockGamepad) {
    ...
    let component = this.mockGamepad.mapping.gamepad.components[componentIndex];
    this.dataSource = this.mockGamepad.mapping.gamepad.dataSources[component.dataSource];
